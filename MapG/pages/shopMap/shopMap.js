...
Page({
  ...
  //      // imageUrl: 'https://www.cvper.com/eleph.png',       // 自定义分享显示的图片

  //       path: `/pages/index/index?c=` + this.data.c  + `&shareEnter=1`   // 自定义分享的地址和参数的传递

  //     }

  //   }

  //   //  r如果用户点击了微信默认的右上角的分享的按钮，就会走下面这段分享的设置

  //   return {

  //     title: '我是默认分享的文案',            //  微信默认分享的文案设置

  //     path: `/pages/index/index?shareEnter=1`   //  微信默认分享的地址的设置
